...
## Introduction
Regional analysis often require matching addresses to a standard geography. This tutorial shows how to retrieve the geography coordinates (latitude and longtitude) of the addresses, and use spatial joins to find out if the addresses falls inside the target geographies. 
